...
int main(int argc, char* argv[])
{
  ...
  std::ofstream out("H:\\source\\repos\\ITLab\\Black_Scholes-without kokkos\\Black-Scholes\\Zameri.txt", std::ios::app); // Указать свой путь для записи результата замеров времени в текстовый файл
  if (out.is_open())
  {
    out << dt << std::endl;
  }
