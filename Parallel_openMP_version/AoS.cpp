...
struct Option
{
  float s0 = 0.0f; // С†РµРЅР° Р°РєС†РёРё РІ РЅР°С‡Р°Р»СЊРЅРѕРµ РІСЂРµРјСЏ
  float T = 0.0f; // РІСЂРµРјСЏ РёСЃРїРѕР»РЅРµРЅРёСЏ РѕРїС†РёРѕРЅР° РІ РіРѕРґР°С…
  float K = 0.0f; // СЃС‚СЂР°Р№Рє
  float C = 0.0f; // РЎРїСЂР°РІРµРґР»РёРІР°СЏ С†РµРЅР° РѕРїС†РёРѕРЅР°
};
